...
private: 
    ...
    bool access_read(uint32_t address, int& stalls, int core_id, Bus* bus, int global_cycle,bool new_instruction);
    bool access_write(uint32_t address, int& stalls, int core_id, Bus* bus, int global_cycle,bool new_instruction);
